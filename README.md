...
1.2 Why This Problem is valuable	4
1.3 Desired State	4
1.4 Previous Research	4
2. Industry Background & Domain Scope	5
3. Stakeholders	5
4. Business question	5
4.1 Main Business Question	5
4.2 Business Value	5
5. Data question	5
5.1 Main Data Question	5
5.2 Data Required	6
6. Data	6
7. Data science process	7
7.1 Exploratory Data Analysis (EDA)	7
7.2 Data Preprocessing & Feature Engineering	9
7.3 Modelling	11
7.3.1 Modelling Overview	11
7.3.2 Data Pipeline	12
7.3.3 Model 1: Simple Custom CNN	12
7.3.4 Model 2: Deep Custom CNN	14
7.3.5 Model 3: Transfer Learning with EfficientNetV2B0	15
7.3.6 Model 4: Transfer Learning with MobileNetV2	17
7.3.7 Model 5: Transfer Learning with ResNet50V2	19
7.3.8 Chosen Model	21
7.4 Outcomes	21
7.5 Implementation	21
8. Data answer	21
9. Business answer	22
10. Response to stakeholders	22
11. End-to-end solution	22
12. References	23
...
•	Labor Intensive: Manual field surveys require expert ornithologists spending hundreds of hours in the field and analysing recordings.
